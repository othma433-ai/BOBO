...
class WhatsAppAccessibilityService : AccessibilityService(), AccessibilityUiDriver {
    ...
    override fun swipeTowardOlderMessages(durationMs: Long): Boolean {
    ...
    override fun swipeTowardNewerMessages(durationMs: Long): Boolean {
        val dm = resources.displayMetrics
        return dispatchSwipe(
    ...
    override fun swipeChatListForward(durationMs: Long): Boolean {
        val dm = resources.displayMetrics
        return dispatchSwipe(
            dm.widthPixels * 0.52f, dm.heightPixels * 0.78f,
            dm.widthPixels * 0.52f, dm.heightPixels * 0.28f, durationMs
    ...
    override fun swipeChatListBackward(durationMs: Long): Boolean {
        val dm = resources.displayMetrics
        return dispatchSwipe(
