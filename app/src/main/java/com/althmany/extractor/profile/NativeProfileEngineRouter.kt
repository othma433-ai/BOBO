...
object NativeProfileEngineRouter {
    fun inspect(context: Context): NativeProfileEngineSnapshot {
        ...
        val preference = UnifiedRuntimeRepository.preference(context)
        val remote = UnifiedRuntimeRepository.isRemoteTarget(context)
        val remoteUser = UnifiedRuntimeRepository.selectedAndroidUserId(context)
